...
var firstPerson = 'Gautam'; // Replace with the actual name
var firstLocation = 'Delhi, India'; // Replace with the actual location

var secondPerson = 'Yagnaaa'; // Replace with the actual name
var secondLocation = 'narayanguda, India';
...
var timeLeaveStamp = new Date(2023, 10, 5);

//first day of renewed contact (year, month, day)
var timeMeetStamp = new Date(2024, 7, 10);
